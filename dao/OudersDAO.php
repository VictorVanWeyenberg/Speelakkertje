...
class OudersDAO extends DAO {
	...
	public function getValidationErrorsUser($data) {
		...
		if(!isset($data['user_pass'])) {
			$errors['user_pass'] = 'user_pass is missing';
		}
		...
		if(!isset($data['user_registered'])) {
			$errors['user_registered'] = 'user_registered is missing';
		}
		if(!isset($data['user_status'])) {
			$errors['user_status'] = 'user_status is missing';
		}
	...
	public function getValidationErrorsParent($data) {
		...
		if(!isset($data['user_id'])) {
			$errors['user_id'] = 'user_id is missing';
		}
		...
		if(!isset($data['registratiedatum'])) {
			$errors['registratiedatum'] = 'registratiedatum is missing';
		}
